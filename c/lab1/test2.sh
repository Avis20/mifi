...
case $1 in
    ...
    ;;
    7)
        echo "Дан список с элементами целого типа. Сформировать новый список, в котором сначала расположены в порядке
        возрастания все четные (по значению) элементы исходного списка, а затем в порядке убывания все нечетные. Все
        списки: исходный и полученный вывести на экран."
    ;;
    66)
