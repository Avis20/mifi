...
case $1 in
    ...
    ;;
    55)
        echo "Дана строка, содержащая слова, разделенные одним или несколькими разделительными символами (пробелами,
        табуляторами), в начале строки и в конце строки также могут находиться разделительные символы. Сформировать
        новую строку, в которую поместить слова исходной строки, являющиеся палиндромами, разделенные одним пробелом. В
